...
export default function RegisterPage() {
  ...
  // Mock handler for Google/Apple / Form
  const handleRegistration = () => {
    login(name.trim() || "Demo User", email.trim() || "demo@example.com");
    ...
    <div className="flex min-h-screen bg-[#F4F4F5]">
      ...
      <div className="flex w-full flex-col p-8 pt-10 sm:p-12 lg:w-1/2 lg:pl-16 lg:pr-12 xl:pl-24 relative">
        ...
        <div className="mx-auto w-full max-w-[400px] mt-24 flex-1 flex flex-col justify-center">
          ...
          <form className={`mt-10 flex flex-col gap-4 ${spaceMono.className}`} onSubmit={(e) => { e.preventDefault(); handleRegistration(); }}>
            <input
              type="text"
        ...
        <div className={`mt-16 text-center text-xs text-gray-500 font-medium ${spaceMono.className}`}>
          ...
          <Link href="/login" className="text-black font-bold underline transition-colors hover:text-gray-700">
            Sign In Here
          </Link>
        </div>
      </div>
